...
block BouncingBall
  ...
  extends FMI.Internal.FMU(logFMICalls=true);
  ...
  parameter FMI3Float64 g = -9.81 "Gravity acting on the ball";
  parameter FMI3Float64 e = 0.7 "Coefficient of restitution";
  FMI3Float64Output h "Position of the ball" annotation(Placement(transformation(extent={ { 100, -60},  { 120, -40}}),   iconTransformation(extent={ { 100, -60},  { 120, -40}})));
  FMI3Float64Output v "Velocity of the ball" annotation(Placement(transformation(extent={ { 100, 40},  { 120, 60}}),   iconTransformation(extent={ { 100, 40},  { 120, 60}})));

initial algorithm

  FMI.Internal.loadFMU(
    instance=instance,
    unzipdir=Modelica.Utilities.Files.loadResource("modelica://FMI/Resources/FMUs/4b6c103"),
    fmiVersion=3,
...
algorithm
  ...
  annotation (
    ...
    Documentation(info="<html><p>For more information open the FMU's <a href=\"modelica://FMI/Resources/FMUs/4b6c103/documentation/index.html\">original documentation</a>.</p></html>"));
end BouncingBall;
