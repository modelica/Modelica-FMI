...
initial algorithm
  ...
  FMI.Internal.loadFMU(
    instance=instance,
    unzipdir=Modelica.Utilities.Files.loadResource("modelica://FMI/Resources/FMUs/11760ee"),
    fmiVersion=2,
...
<p>For more information open the FMU's <a href=\"modelica://FMI/Resources/FMUs/11760ee/documentation/index.html\">original documentation</a>.</p>
</html>"));
end Resource2;
