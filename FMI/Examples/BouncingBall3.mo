...
initial algorithm
  ...
  FMI.Internal.loadFMU(
    instance=instance,
    unzipdir=Modelica.Utilities.Files.loadResource("modelica://FMI/Resources/FMUs/f14f1f4"),
    fmiVersion=3,
...
<p>For more information open the FMU's <a href=\"modelica://FMI/Resources/FMUs/f14f1f4/documentation/index.html\">original documentation</a>.</p>
</html>")
  );
end BouncingBall3;