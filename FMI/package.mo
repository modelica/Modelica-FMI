...
annotation (version="0.0.5", uses(Modelica(version="4.0.0")), Icon(graphics={Bitmap(extent={{-80,-60},
...
<pre>uv tool install --reinstall https://github.com/modelica/modelica-fmi/releases/download/v0.0.5/modelica_fmi-0.0.5-py3-none-any.whl</pre>
