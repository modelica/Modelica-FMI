...
annotation (version="0.0.1", uses(Modelica(version="4.0.0")), Icon(graphics={Bitmap(extent={{-80,-60},
...
<pre>uv tool install --reinstall https://github.com/modelica/modelica-fmi/releases/download/v0.0.1/modelica_fmi-0.0.1-py3-none-any.whl</pre>
