...
use crate::sundials::{sundials_nonlinearsolver::SUNNonlinearSolver, sundials_nvector::N_Vector, sundials_types::SUNContext};
...
pub unsafe fn SUNNonlinSol_Newton(y: N_Vector, sunctx: SUNContext) -> SUNNonlinearSolver;
