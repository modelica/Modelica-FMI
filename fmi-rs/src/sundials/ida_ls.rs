...
use crate::sundials::{sundials_linearsolver::SUNLinearSolver, sundials_matrix::SUNMatrix, sundials_nvector::N_Vector, sundials_types::{SUNContext, sunrealtype}};
...
pub type IDALsJacFn = unsafe extern "C" fn(t: sunrealtype, c_j: sunrealtype, y: N_Vector,
    yp: N_Vector, r: N_Vector, Jac: SUNMatrix, user_data: *mut c_void,
    tmp1: N_Vector, tmp2: N_Vector, tmp3: N_Vector) -> i32;
...
//                                        SUNMatrix A);
pub unsafe fn IDASetLinearSolver(ida_mem: *mut c_void, LS: SUNLinearSolver,
    A: SUNMatrix) -> i32;
...
pub unsafe fn IDASetJacFn(ida_mem: *mut c_void, jac: IDALsJacFn) -> i32;
